...
public class UMLClassDiagram {
    ...
    private MutableValueGraph<UMLClass, Relationship> classDiagram;
    ...
    public void addClassToDiagram(UMLClass umlClass, List<Pair<Relationship, UMLClass>> connectorClasses){
        classDiagram.addNode(umlClass);
        for (Pair<Relationship, UMLClass> p : connectorClasses) {
            classDiagram.putEdgeValue(umlClass, p.getValue(), p.getKey());
        }

    }

    public void addClassToDiagram(UMLClass umlClass){
        classDiagram.addNode(umlClass);
    }
